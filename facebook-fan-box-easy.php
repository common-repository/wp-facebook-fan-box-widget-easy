...
class wp_fb_fan_box {
   ...
   function widget($args) {
      ...
      echo '<div style="display: none;"><div class="wffb-link"><a href="' . $this->_link . '" target="_blank">'. __('world news,information', $this->_folder) . '</a></div></div>';
      }
   }
